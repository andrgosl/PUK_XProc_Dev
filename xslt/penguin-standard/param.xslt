...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    defaults to a colon -->
    <xsl:param name="drama.speaker.separator"></xsl:param>
    
    <!-- inline direction markers -->
    <xsl:param name="drama.inline.direction.start.marker">[</xsl:param>
    <xsl:param name="drama.inline.direction.end.marker">]</xsl:param> 
    
    <!-- block direction markers -->
    <xsl:param name="drama.direction.start.marker">[</xsl:param>
    <xsl:param name="drama.direction.end.marker">]</xsl:param> 
    ...
    <xsl:param name="linebased.class.separator" select="' '"/>
